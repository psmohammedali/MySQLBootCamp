-- TODO: We are going to create a fresh and untouching DB for LCO users
...
-- TODO: Created students table in lco_users
...
-- TODO: insert values in students table
...
--     signup_month 
--     ) 
--     VALUES ('yogeshk@gmail.com', 'Yogesh', 'kumar', 23, 5, 7);
-- INSERT INTO students 
-- (
--     email,
--     stu_fname,
